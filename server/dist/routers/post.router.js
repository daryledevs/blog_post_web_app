...
const controller = new post_controller_1.default(new post_service_impl_1.default(new post_repository_impl_1.default(), new user_repository_impl_1.default(), new cloudinary_service_util_1.default()));
