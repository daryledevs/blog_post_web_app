...
const db_database_1 = require("./infrastructure/database/db.database");
const socket_io_1 = require("socket.io");
const dotenv = __importStar(require("dotenv"));
const socket_config_1 = __importDefault(require("./config/socket.config"));
const socket_service_lib_1 = __importDefault(require("./application/libs/socket-service.lib"));
const http_1 = require("http");
dotenv.config();
const server = (0, http_1.createServer)(app_1.default);
const io = new socket_io_1.Server(server, socket_config_1.default);
const socketService = new socket_service_lib_1.default();
